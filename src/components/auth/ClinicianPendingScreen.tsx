...
interface ClinicianPendingScreenProps { clinicianName?: string; clinicianData?: Partial<Clinician> | null; onRefresh: () => void; onSignOut: () => void; }

export default function ClinicianPendingScreen({ clinicianName, clinicianData, onRefresh, onSignOut }: ClinicianPendingScreenProps) {
