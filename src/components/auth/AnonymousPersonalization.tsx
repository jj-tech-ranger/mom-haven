...
export default function AnonymousPersonalization({ onDone }: Props) {
  ...
  return <div className="space-y-5">
    <div className="flex items-center gap-2 text-[var(--haven-orchid)] text-xs font-display font-bold uppercase tracking-wider"><Sparkles className="h-4 w-4" /> Personalize privately</div>
    <div><h2 className="font-display font-extrabold text-xl">Make your anonymous visit more useful</h2><p className="mt-1 text-sm text-[var(--text-secondary)]">These preferences stay on this device until you choose to create an account.</p></div>
    ...
    {step === 2 && stage !== 'pregnancy' && <div className="rounded-2xl bg-[var(--surface-2)] p-5 text-sm text-[var(--text-secondary)]">You can personalize more later. For now, we'll tailor the anonymous experience to your selected journey.</div>}
